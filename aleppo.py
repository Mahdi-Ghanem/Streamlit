...
data = {
    "Produkt": [
        ...
        "ALUFolie 150m",
        "B3 Deckel 100 st",
        "B3 Salatschale Weiß 100 st",
        "CC375 BOX PP375 ML 50St",
        "CC50 Sossenbecher",
        "CC80 Sossenbecher",
        "Deckel 500 ST",
        "Döner Beutel 16×16",
        ...
        "Döner Box KLEIN",
        "Gabel Plastik",
        "Hamburgerbox Klein 100st",
        "HP3 WARMHALTEVERPACKUNG LANCH 125st",
        "Menubox Ungeteilt Beige 100st",
        "Papp Schalen GROß",
        "Papp Schalen KLEIN",
        "Pragsmentpapier 1/4",
        "Pergamentpapier 1/16",
        "Pizza Box 26",
        "Pizza Box 30",
        "Servietten",
        "Trinkbecher 100 st"
